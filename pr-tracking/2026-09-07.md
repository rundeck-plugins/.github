# PR Report - 2026-09-07

## Summary

| Repository | Open PRs | Open Issues | Needs Attention |
|------------|----------|-------------|-----------------|
| [git-plugin](https://github.com/rundeck-plugins/git-plugin/pulls) | 1 | [2](https://github.com/rundeck-plugins/git-plugin/issues) | **1** |
| [docker](https://github.com/rundeck-plugins/docker/pulls) | 0 | [1](https://github.com/rundeck-plugins/docker/issues) | 0 |
| [ansible-plugin](https://github.com/rundeck-plugins/ansible-plugin/pulls) | 1 | [0](https://github.com/rundeck-plugins/ansible-plugin/issues) | **1** |
...
| [http-notification](https://github.com/rundeck-plugins/http-notification/pulls) | 1 | [0](https://github.com/rundeck-plugins/http-notification/issues) | **1** |
| [jq-json-logfilter](https://github.com/rundeck-plugins/jq-json-logfilter/pulls) | 1 | [0](https://github.com/rundeck-plugins/jq-json-logfilter/issues) | **1** |
| [rundeck-azure-plugin](https://github.com/rundeck-plugins/rundeck-azure-plugin/pulls) | 2 | [0](https://github.com/rundeck-plugins/rundeck-azure-plugin/issues) | **1** |
...
**Total Open PRs:** 14 across 11 repositories
**Total Open Issues:** 3 across 2 repositories
**PRs Needing Attention:** 12
...
- **sshj-plugin #160**: [RUN-0000] Update dependency js-yaml to v5.4.1
  - Last activity: opened by @app/renovate
  - Link: https://github.com/rundeck-plugins/sshj-plugin/pull/160
...
| [sshj-plugin](https://github.com/rundeck-plugins/sshj-plugin/compare/1.0.8...main) | 1.0.8 | 6 | **NEEDS RELEASE** |
