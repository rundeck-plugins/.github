...
**Total Open PRs:** 30 across 24 repositories
...
- **rundeck-plugin-examples #34**: [RUN-0000] Update gradle minor/patch dependencies to v2.22.3
  - Last activity: opened by @app/renovate
  - Link: https://github.com/rundeck-plugins/rundeck-plugin-examples/pull/34

- **rundeck-plugin-examples #33**: [RUN-0000] Update dependency com.fasterxml.jackson:jackson-bom to v2.22.3
  - Last activity: opened by @app/renovate
  - Link: https://github.com/rundeck-plugins/rundeck-plugin-examples/pull/33

- **rundeck-ec2-nodes-plugin #240**: [RUN-0000] Update gradle minor/patch dependencies
  - Last activity: opened by @app/renovate
  - Link: https://github.com/rundeck-plugins/rundeck-ec2-nodes-plugin/pull/240

- **sshj-plugin #174**: [RUN-0000] Update dependency @types/node to v24.13.6
  - Last activity: opened by @app/renovate
  - Link: https://github.com/rundeck-plugins/sshj-plugin/pull/174

- **vault-storage #118**: [RUN-0000] Update dependency ch.qos.logback:logback-classic to v1.6.3
  - Last activity: opened by @app/renovate
  - Link: https://github.com/rundeck-plugins/vault-storage/pull/118
...
|------------|-----------------|----------------|--------|
| [aws-s3-model-source](https://github.com/rundeck-plugins/aws-s3-model-source/compare/2.0.4...main) | 2.0.4 | 4 | **NEEDS RELEASE** |
| [yaml-text-source](https://github.com/rundeck-plugins/yaml-text-source/compare/3.0.2...main) | 3.0.2 | 4 | **NEEDS RELEASE** |
| [puppet-apply-step](https://github.com/rundeck-plugins/puppet-apply-step/compare/3.0.2...main) | 3.0.2 | 2 | **NEEDS RELEASE** |
| [sshj-plugin](https://github.com/rundeck-plugins/sshj-plugin/compare/1.0.9...main) | 1.0.9 | 9 | **NEEDS RELEASE** |
| [slack-incoming-webhook-plugin](https://github.com/rundeck-plugins/slack-incoming-webhook-plugin/compare/2.0.4...main) | 2.0.4 | 2 | **NEEDS RELEASE** |
| [salt-step](https://github.com/rundeck-plugins/salt-step/compare/1.0.5...main) | 1.0.5 | 2 | **NEEDS RELEASE** |
| [rundeck-s3-log-plugin](https://github.com/rundeck-plugins/rundeck-s3-log-plugin/compare/3.0.6...main) | 3.0.6 | 2 | **NEEDS RELEASE** |
| [rundeck-ec2-nodes-plugin](https://github.com/rundeck-plugins/rundeck-ec2-nodes-plugin/compare/2.1.0...main) | 2.1.0 | 24 | **NEEDS RELEASE** |
| [rundeck-azure-storage-plugin](https://github.com/rundeck-plugins/rundeck-azure-storage-plugin/compare/2.0.2...main) | 2.0.2 | 4 | **NEEDS RELEASE** |
| [rundeck-azure-plugin](https://github.com/rundeck-plugins/rundeck-azure-plugin/compare/2.0.7...main) | 2.0.7 | 2 | **NEEDS RELEASE** |
| [py-winrm-plugin](https://github.com/rundeck-plugins/py-winrm-plugin/compare/3.3.0...main) | 3.3.0 | 4 | **NEEDS RELEASE** |
| [ansible-plugin](https://github.com/rundeck-plugins/ansible-plugin/compare/5.1.3...main) | 5.1.3 | 2 | **NEEDS RELEASE** |
| [attribute-match-node-enhancer](https://github.com/rundeck-plugins/attribute-match-node-enhancer/compare/1.0.6...main) | 1.0.6 | 4 | **NEEDS RELEASE** |
| [aws-s3-steps](https://github.com/rundeck-plugins/aws-s3-steps/compare/2.0.2...main) | 2.0.2 | 4 | **NEEDS RELEASE** |
| [http-notification](https://github.com/rundeck-plugins/http-notification/compare/2.0.6...main) | 2.0.6 | 2 | **NEEDS RELEASE** |
| [http-step](https://github.com/rundeck-plugins/http-step/compare/2.0.6...main) | 2.0.6 | 5 | **NEEDS RELEASE** |
| [jq-json-logfilter](https://github.com/rundeck-plugins/jq-json-logfilter/compare/2.0.4...main) | 2.0.4 | 2 | **NEEDS RELEASE** |
| [kubernetes](https://github.com/rundeck-plugins/kubernetes/compare/3.0.5...main) | 3.0.5 | 4 | **NEEDS RELEASE** |
| [multiline-regex-datacapture-filter](https://github.com/rundeck-plugins/multiline-regex-datacapture-filter/compare/2.0.4...main) | 2.0.4 | 2 | **NEEDS RELEASE** |
| [openssh-node-execution](https://github.com/rundeck-plugins/openssh-node-execution/compare/3.0.2...main) | 3.0.2 | 2 | **NEEDS RELEASE** |
| [pagerduty-notification](https://github.com/rundeck-plugins/pagerduty-notification/compare/2.0.4...main) | 2.0.4 | 4 | **NEEDS RELEASE** |
| [vault-storage](https://github.com/rundeck-plugins/vault-storage/compare/2.0.5...main) | 2.0.5 | 15 | **NEEDS RELEASE** |
| [docker](https://github.com/rundeck-plugins/docker/compare/2.0.3...main) | 2.0.3 | 2 | **NEEDS RELEASE** |
| [nixy-step-plugins](https://github.com/rundeck-plugins/nixy-step-plugins/compare/2.2.0...main) | 2.2.0 | 2 | **NEEDS RELEASE** |
